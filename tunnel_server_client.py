...
class TLSTunnel():
            ...
            try:
                ...
                if e.args[0] == errno.EAGAIN or e.args[0] == errno.EWOULDBLOCK:
                    ...
                    if shouldSendFakePacket() and self.fakepackets == 1:
                        ...
                        buf = self.packet_to_bytes(fake_packet, self.padding, fake_packet = True)
                    else:
    ...
    def packet_to_bytes(packet, add_padding = True, max_length = 300, fake_packet = False):
        # First byte:
        ...
        fake_mask = b'\x01'
        padd_mask = b'\x02'
        byte1 = bytes([(add_padding * padd_mask)[0] | (fake_packet * fake_mask)[0]])
        bb1 = bytearray(byte1)
